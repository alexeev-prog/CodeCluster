...
hidden if the `example_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `example_DEVELOPER_MODE` to the configure
...
Runs the executable target `example_exe`.
